"""
Django settings for reima project.
...
SECRET_KEY = 'django-insecure-_oni1)qh*&clj#!+h%-#1*a=$oou4k!7k#!j=4lrz5uv%8o7mb'
...
WSGI_APPLICATION = 'reima.wsgi.application'
